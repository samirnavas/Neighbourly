      ...
      <div className="px-4 mb-6">
        <div className="flex p-1.5 bg-gray-100 rounded-[1.25rem] border border-gray-200/50">
          <button
            ...
            className={`flex-1 py-3 text-sm font-bold rounded-xl transition-all ${activeTab === "listings"
          ...
          <button
            ...
            className={`flex-1 py-3 text-sm font-bold rounded-xl transition-all ${activeTab === "rented"
                ? "bg-white text-gray-900 shadow-md"
                : "text-gray-500 hover:text-gray-700"
              }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-3 text-sm font-bold rounded-xl transition-all ${activeTab === "history"
                ? "bg-white text-gray-900 shadow-md"
                : "text-gray-500 hover:text-gray-700"
              }`}
          >
